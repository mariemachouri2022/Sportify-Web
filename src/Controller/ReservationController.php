...
public function new(Request $request, EntityManagerInterface $entityManager, ): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        #$matchMailer->sendMatchDetails($reservation, 'wael.marwani@esprit.tn');
    
    // Correctly pass both arguments to the sendSMS method
   # $recipientPhone = '25162501';
    #$matchMailer->sendSMS($recipientPhone, $reservation); // Now passing both parameters
